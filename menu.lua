...
buttonsProps[#buttonsProps+1] = {name = txt[config.lang]["menu_spawn_propsb_title"], func = "SpawnPropsb"}
buttonsProps[#buttonsProps+1] = {name = txt[config.lang]["menu_spawn_propspb_title"], func = "SpawnPropspb"}
buttonsProps[#buttonsProps+1] = {name = txt[config.lang]["menu_spawn_propssp_title"], func = "SpawnPropssp"}
buttonsProps[#buttonsProps+1] = {name = txt[config.lang]["menu_remove_all_props_title"], func = "RemoveAllProps"}
buttonsProps[#buttonsProps+1] = {name = txt[config.lang]["menu_remove_all_props_title2"], func = "RemoveAllPropspb"}
buttonsProps[#buttonsProps+1] = {name = txt[config.lang]["menu_remove_all_props_title1"], func = "RemoveAllPropsc"}
buttonsProps[#buttonsProps+1] = {name = txt[config.lang]["menu_remove_all_props_title3"], func = "RemoveAllPropssp"}
...
function StandBy2()
	Citizen.CreateThread(function()
        TaskStartScenarioInPlace(GetPlayerPed(-1), "WORLD_HUMAN_AA_SMOKE", 0, 1)
        Citizen.Wait(20000)
        ClearPedTasksImmediately(GetPlayerPed(-1))
    end)
	drawNotification(txt[config.lang]["menu_being_stand_by_notification"])
